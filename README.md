...
Allocation Complexity: O(1)</br> 
Allocation Complexity: N/A</br>
...
Allocation Complexity: O(1)</br>  
Deallocation Complexity: O(1)</br>  
...
Allocation Complexity: O(n), where n is the size of the free list</br>  
Deallocation Complexity: O(n), where n is the size of the free list</br>  
Storage Complexity: O(n), where n is the requested allocation size
